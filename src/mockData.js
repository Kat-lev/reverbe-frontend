...
_______________________________________________Llista de correu Diari -- diari@raio.issim.net Per donar-se de baixa envieu un correu a diari-leave@raio.issim.net`,
    data: "2025-06-11T11:13:30",
    reverberacions: [
      {
        id: "b2e86d28-4b14-4739-a469-11844db94e2d",
        missatge_original_id: "f8c0cccc-ffc0-48f9-b119-f85c0f7cffea",
        assumpte: '[Futurs] Re: [Diari] "Ram"',
        remitent: "futurs@raio.issim.net",
        cos: `i el futur és una festa
...
> [centraleta-id: f8c0cccc-ffc0-48f9-b119-f85c0f7cffea]`,
        data: "2025-06-17T20:46:32",
      },
    ],
  },
  {
    id: "81410a66-e2cd-4e37-bb2d-209c205e0eff",
    assumpte: '[Diari] "Recuerdo recuerdo"',
    remitent: "diari@raio.issim.net",
    cos: `Assumpte: Recuerdo recuerdo
...
_______________________________________________Llista de correu Diari -- diari@raio.issim.net Per donar-se de baixa envieu un correu a diari-leave@raio.issim.net`,
    data: "2025-06-19T08:10:40",
    reverberacions: [
      {
        id: "563d84ae-5ab5-45e0-9c36-a2e92bbb740f",
        missatge_original_id: "81410a66-e2cd-4e37-bb2d-209c205e0eff",
        assumpte: '[Ihopethismessagefindsyouwell] Re: [Diari] "Recuerdo recuerdo"',
        remitent: "ihopethismessagefindsyouwell@raio.issim.net",
        cos: `￼                       _  _  _  _ _   _ _ _ //)(-_) _) (-/)(/(-/                _/      > El 19 juny 2025, a les 11:03, central@mail.issim.net va escriure:> > Assumpte: Recuerdo recuerdo> > Missatge:> Un día de invierno pero soleado, frío pero cálido, dentro de la institución pero fuera de ella, escuchando pero ensimismando, hablando pero callando. Nos recuerdo en la terraza pero inclinada, en el conflicto pero en el estar juntas. Los demás pero yo, yo pero los demás, tu pero yo, yo pero tu. El dinero pero la responsabilidad, la responsabilidad pero la vida, la vida pero el tiempo, el tiempo pero los plazos, los plazos pero el privilegio.> > Adjunts:> > _______________________________________________Llista de correu Diari -- diari@raio.issim.net Per donar-se de baixa envieu un correu a diari-leave@raio.issim.net> > > [centraleta-id: 81410a66-e2cd-4e37-bb2d-209c205e0eff]`,
        data: "2025-06-20T13:10:44",
      },
    ],
  },
  {
    id: "b7a0d472-f942-4c14-b711-6551f41b09b8",
    assumpte: '[Diari] "Sobre la dificultad de recordar un jueves por la mañana"',
    remitent: "diari@raio.issim.net",
    cos: `Assumpte: Sobre la dificultad de recordar un jueves por la mañana
